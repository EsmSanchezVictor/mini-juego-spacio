...
export class Mandos extends Container {
    ...
    constructor() {
        super();
            ...
            this.adelante = new Button(Texture.from("adelante"),"adelante");
          
            this.adelante.position.x = 1050;
      
            this.atras = new Button(Texture.from("atras"),"atras");
           
            this.repetir = new Button(Texture.from("repetir"),"repetir");
            this.repetir.position.x = 700;
            
            this.home = new Button(Texture.from("home"),"home");
